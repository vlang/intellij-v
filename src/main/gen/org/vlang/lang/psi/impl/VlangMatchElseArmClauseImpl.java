...
public class VlangMatchElseArmClauseImpl extends VlangCompositeElementImpl implements VlangMatchElseArmClause {

  public VlangMatchElseArmClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VlangVisitor visitor) {
    visitor.visitMatchElseArmClause(this);
  }
