...
public class VlangLabeledStatementImpl extends VlangStatementImpl implements VlangLabeledStatement {

  public VlangLabeledStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
