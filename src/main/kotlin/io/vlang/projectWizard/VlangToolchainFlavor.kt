...
import io.vlang.projectWizard.ToolchainUtil.hasExecutable
import io.vlang.projectWizard.ToolchainUtil.pathToExecutable
...
abstract class VlangToolchainFlavor {
    ...
    companion object {
        private val EP_NAME: ExtensionPointName<VlangToolchainFlavor> =
            ExtensionPointName.create("io.vlang.toolchainFlavor")
