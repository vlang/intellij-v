...
class VlangParserDefinition : ParserDefinition {
    ...
    companion object {
        ...
        val KEYWORDS = TokenSet.create(
            ...
            INTERFACE, MODULE, IN, NOT_IN, RETURN, SELECT, STRUCT, SWITCH, TYPE_, PUB, AS, MUT, IF_COMPILE_TIME, ELSE_COMPILE_TIME,
            UNSAFE, BUILTIN_GLOBAL, ASSERT, ENUM, MATCH, C_INCLUDE, C_FLAG, OR, IS, NOT_IS, FOR_COMPILE_TIME, UNION,
        )
