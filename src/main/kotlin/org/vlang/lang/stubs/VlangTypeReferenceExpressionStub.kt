...
class VlangTypeReferenceExpressionStub(parent: StubElement<*>?, elementType: IStubElementType<*, *>?, ref: StringRef?) :
    StubWithText<VlangTypeReferenceExpression>(parent, elementType, ref) {
