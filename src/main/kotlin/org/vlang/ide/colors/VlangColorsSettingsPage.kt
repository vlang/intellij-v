...
pub fn (mut <MUTABLE_RECEIVER>cs</MUTABLE_RECEIVER> <PUBLIC_STRUCT>PublicCodeStorage</PUBLIC_STRUCT>) <PUBLIC_FUNCTION>public_method</FUNCTION>() {
...
pub fn (<RECEIVER>cs</RECEIVER> <PUBLIC_STRUCT>PublicCodeStorage</PUBLIC_STRUCT>) <PUBLIC_FUNCTION>immutable_method</FUNCTION>(<PARAMETER>a</PARAMETER> <BUILTIN_TYPE>int</BUILTIN_TYPE>, mut <MUTABLE_PARAMETER>b</MUTABLE_PARAMETER> <BUILTIN_TYPE>u8</BUILTIN_TYPE>) {
